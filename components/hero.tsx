    ...
    <LampContainer>
      ...
      >
        <Link
          ...
          className='text-center px-24 py-3 lg:px-16 shadow-[0_4px_14px_0_rgb(0,118,255,39%)] hover:shadow-[0_6px_20px_rgba(0,118,255,23%)] hover:bg-transparent border border-blue-500 hover:border-blue-500 bg-[#0070f3] text-gray-200 font-medium hover:font-semibold transition duration-200 ease-linear'
        >
          Hire Me
        </Link>
        <Link
