  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-16 font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-neutral text-neutral-foreground shadow-sm hover:bg-primary hover:text-foreground",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        "navigation-link":
          "text-foreground underline-offset-4 hover:underline hover:bg-primary",
      },
      size: {
        default: "h-9 px-4 py-2",
        sm: "h-8 rounded-md px-3 text-16",
        lg: "h-12 rounded-md px-8 text-20 font-semibold",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
