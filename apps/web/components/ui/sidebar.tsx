...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "md:flex md:flex-col hidden h-full w-[10px] flex-shrink-0 bg-neutral-100 px-4 py-4 dark:bg-neutral-800",
          className,
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "md:hidden flex h-10 flex-row items-center justify-between bg-neutral-100 px-4 py-4 dark:bg-neutral-800",
        )}
        {...props}
      >
